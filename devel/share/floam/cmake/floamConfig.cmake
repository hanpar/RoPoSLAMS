...
if("TRUE" STREQUAL "TRUE")
  set(floam_SOURCE_PREFIX /home/vishrut/ros_workspaces/eecs568-group17-project/src/floam)
  set(floam_DEVEL_PREFIX /home/vishrut/ros_workspaces/eecs568-group17-project/devel)
  set(floam_INSTALL_PREFIX "")
  set(floam_PREFIX ${floam_DEVEL_PREFIX})
else()
  set(floam_SOURCE_PREFIX "")
  set(floam_DEVEL_PREFIX "")
  set(floam_INSTALL_PREFIX /home/vishrut/ros_workspaces/eecs568-group17-project/install)
...
if(NOT "/home/vishrut/ros_workspaces/eecs568-group17-project/src/floam/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(floam_INCLUDE_DIRS "")
  set(_include_dirs "/home/vishrut/ros_workspaces/eecs568-group17-project/src/floam/include;/usr/include/eigen3;/usr/include/pcl-1.10;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2")
  if(NOT " " STREQUAL " ")
  ...
  elseif(NOT "https://wanghan.pro " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Vishrut Kaushik <vishrutskaushik@gmail.com>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'floam' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vishrut/ros_workspaces/eecs568-group17-project/src/floam/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/vishrut/ros_workspaces/eecs568-group17-project/devel/lib;/home/vishrut/ros_workspaces/eecs568-group17-project/devel/lib;/opt/ros/noetic/lib)
...
foreach(depend ${depends})
  ...
  _list_append_deduplicate(floam_EXPORTED_TARGETS ${${floam_dep}_EXPORTED_TARGETS})
endforeach()
